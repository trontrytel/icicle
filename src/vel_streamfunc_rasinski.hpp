 ...
 */
#ifndef VEL_STREAMFUNC_RASINSKI_HPP
#  define VEL_STREAMFUNC_RASINSKI_HPP

#  include "config.hpp" // USE_* defines
#  include "common.hpp" // root class, error reporting
#  include "vel_streamfunc.hpp"

template <typename real_t>
class vel_streamfunc_rasinski : public vel_streamfunc<real_t>
{
  ...
  public: vel_streamfunc_rasinski(
